...
- (void)awakeFromNib {
    ...
    // font
    //
    [self.mLblTitle setFont:[PHTextHelper myriadProBold:[PHTextHelper fontNoticeMedium]]];
    [self.mLblValue setFont:[PHTextHelper myriadProBold:[PHTextHelper fontSizeLarge]]];
}
